...
user_url = str(input('Enter Target Website URL To Scan: '))
urls = deque([user_url])
...
try:
    while len(urls):
        ...
        new_nums = set(re.findall(r"(?:^|\s)(((?:\+|0{2})(?:49|43|33|65|63)[-\. ]?|0)([1-9]\d{1,2}[-\. ]?|\([1-9]\d{1,2}\)[-\. ]?)(\d{6,9}|\d{2,3}[-\. ]\d{4,6}))", response.text))
